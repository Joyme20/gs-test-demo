  ...
  mounted() {
    ...
    BimAir.Loader({ isShareArrayBuffer: true }).then(() => {
      ...
      viewer.loadModels([id, model1], true).then((lightModels) => {
        ...
        let roamTime = 4;
        let moveObjId1 = "QMD+M+4G+HYD+XDRA01+EL003";
        ...
        let moveObjId2 = "QMD+M+4G+HYD+XDRA01+EL002";
      ...
      viewer2.loadModels([id, model1, m9, m8], true).then((lightModels2) => {
        ...
        let roamTime2 = 3;
        let moveObjId_1 = "QMD+M+4G+HYD+XDRA01+EL003";
        ...
        let moveObjId_2 = "QMD+M+4G+HYD+XDRA01+EL002";
